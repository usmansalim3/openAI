...
import ImageCard from './ImageCard.js/ImageCard';
  ...
  return (
    ...
    <View style={{flex:1,backgroundColor:'#202123'}}>
      <View style={{width:"75%",alignSelf:'center',position:'absolute'}}>
        <Searchbar
        iconColor='#AAACB7'
        style={{top:responsiveHeight(1.5),backgroundColor:'#282c34',color:'#AAACB7',borderRadius:30,elevation:0,height:45,zIndex:1}}
